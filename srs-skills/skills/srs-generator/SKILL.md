...
metadata:
  ...
  references: skills/srs-generator/references/srs-template.md, skills/srs-generator/references/gap-detection-guide.md
---
...
Load `skills/srs-generator/references/gap-detection-guide.md`. Run all 7 patterns. Output:
...
Populate `skills/srs-generator/references/srs-template.md` with all gathered information.
