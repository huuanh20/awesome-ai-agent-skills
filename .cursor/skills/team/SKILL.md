...
Read `.cursor/skills/team-ba/SKILL.md`, then follow it with this input:
...
Read `.cursor/skills/team-techlead/SKILL.md`, then follow it with this input:
...
Read `.cursor/skills/team-pm/SKILL.md`, then follow it with this input:
...
Read `.cursor/skills/team-dev/SKILL.md`, then follow it with this input:
...
Read `.cursor/skills/team-fe/SKILL.md`, then follow it with this input:
...
Read `.cursor/skills/team-test/SKILL.md`, then follow it with this input:
...
Read `.cursor/skills/team-qa/SKILL.md`, then follow it with this input:
...
```bash
python .cursor/hooks/flag_aggregator.py --dir projects/{slug}/team/
```
