...
- `.cursor/skills/srs-generator/references/srs-template.md`
- `.cursor/skills/srs-generator/references/gap-detection-guide.md`

**Context files (load if present — created by `.cursor/scripts/init_project.py`):**
...
Load `.cursor/skills/srs-generator/references/gap-detection-guide.md`. Run all 7 patterns. Output:
...
Populate `.cursor/skills/srs-generator/references/srs-template.md` with all gathered information.
