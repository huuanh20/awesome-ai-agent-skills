...
- [Advanced Usage](.cursor/skills/sequential-thinking/references/advanced.md) - Revision and branching patterns
- [Examples](.cursor/skills/sequential-thinking/references/examples.md) - Real-world use cases
