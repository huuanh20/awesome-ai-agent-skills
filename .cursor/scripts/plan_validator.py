...
Usage:
    python .cursor/scripts/plan_validator.py --dir projects/myproject/plan/
    python .cursor/scripts/plan_validator.py --dir projects/myproject/plan/ --format json
    python .cursor/scripts/plan_validator.py --dir projects/myproject/plan/ --stats
"""
