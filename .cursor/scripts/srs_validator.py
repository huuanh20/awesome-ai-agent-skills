...
Usage:
    python .cursor/scripts/srs_validator.py docs/srs-myproject-20260614.md
    python .cursor/scripts/srs_validator.py docs/srs-myproject-20260614.md --format json
    python .cursor/scripts/srs_validator.py docs/srs-myproject-20260614.md --strict
"""
