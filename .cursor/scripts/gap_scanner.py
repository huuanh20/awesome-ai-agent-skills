...
Usage:
    python .cursor/scripts/gap_scanner.py requirements.txt
    echo "Users should be able to login fast" | python .cursor/scripts/gap_scanner.py -
    python .cursor/scripts/gap_scanner.py requirements.txt --format json
    python .cursor/scripts/gap_scanner.py requirements.txt --min-priority P2
"""
